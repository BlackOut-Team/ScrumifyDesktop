    ...
    private void sendEmailReset(String email) {
        ...
        try {
            ...
            try {
                ...
                message.setSubject("Reset you Scrumify  Account password");
                ...
                String html = "Scrumify\n" + "Reset Password" + "\n<a href='http://localhost/scrumify/web/app_dev.php/resetting/check-email?username="+crud.findByEmail(email)+"'>Reset now</a>";
