...
import scrumifyd.GestionProjets.controllers.CurrentProjectsController;
import scrumifyd.GestionProjets.controllers.ItemController;
...
public class MeetingsController implements Initializable {
    ...
    int user_id;
    public int pr_id;
    public static ProjectSession projectSess  ;
   ...
   public void setPrId() {
        this.pr_id = projectSess.getProjectId();
    }
    ...
    public void refreshNodes() {
        ...
        try {
            ...
            System.out.println("Meetings pr id "+CurrentProjectsController.prSession.getProjectId());
            pr_id = CurrentProjectsController.prSession.getProjectId();
            System.out.println(pr_id);
            ListM = Meetings.getAllMeetings(pr_id);
            //CurrentProjectsController.prSession.cleanUserSession();
                                ...
                                public void handle(MouseEvent e) {
                                    if (e.getSource() == box.EditButton) {
                                        try {
                                            ...
                                            mc.setSprint(meeting.getSprint());
    ...
    public void AddMeeting(MouseEvent event) {
        try {
            ...
            ProjectSession.getInstace(pr_id);
            sp.setProjectId(pr_id);
